...
/**
 * r_insert_node - node val instertion in a AVL.
 * @tree: type **pointer of root node of the AVL tree struct.
 * @parent: parent node of struct AVL in prog.
 * @new: type**pointer left or right insertion in prog.
 * @nval: insertion value of the AVL in prog.
...
/**
 * avl_insert - inserts a val into an AVL tree.
 * @tree: type **pointer to the root node of the AVL tree to insert into.
 * @value: val to store in the node to be inserted
